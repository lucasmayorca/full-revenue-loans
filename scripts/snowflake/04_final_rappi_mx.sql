-- Query final: Rappi MX, ofertas REGULAR vigentes, top 2 por monto
-- Filtra ofertas por PARTNER_ID literal (más estricto que currency=MXN)
...
WITH ranked_offers AS (
  ...
  WHERE o.STATUS = 'AVAILABLE'
    ...
    AND o.PARTNER_ID = '72ce077d-35a5-4e6d-a8f4-2dd80c9ef408'  -- Rappi MX
