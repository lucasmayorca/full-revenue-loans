...
import { Store, Landmark, FileText, MapPin, ShieldCheck, TrendingUp } from "lucide-react";
...
function IgIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none">
      <defs>
        <linearGradient id="ig-ul-rappi-grad" x1="0%" y1="100%" x2="100%" y2="0%">
      ...
      <rect x="2" y="2" width="20" height="20" rx="5" ry="5" fill="url(#ig-ul-rappi-grad)"/>
...
const SOURCES: Source[] = [
  { key: "ubereats",  label: "Ventas históricas en Rappi",    icon: <Store className="w-4 h-4" />,        delayMs: 700  },
        ...
        <div className="space-y-2">
          {SOURCES.map((source) => {
            ...
            return (
              <div
                key={source.key}
                className={`flex items-center gap-3 rounded-2xl px-4 py-3 transition-colors duration-500 ${
                  isDone
