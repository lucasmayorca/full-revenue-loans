  ...
  if (isEvaluating) {
    return (
      <div className="max-w-[640px] mx-auto px-4 py-8 flex flex-col items-center text-center gap-6">
        <div className="w-20 h-20 rounded-full bg-rappi-orange flex items-center justify-center shadow-lg">
          ...
          <div className="space-y-2.5">
            {[
              ...
              <div key={i} className="flex items-start gap-2.5">
                <span className="w-5 h-5 rounded-full bg-rappi-orange text-white text-[11px] font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                  {i + 1}
                </span>
        ...
        <a
          href="/offers"
          className="text-[14px] text-uber-gray-500 underline underline-offset-2 hover:text-rappi-orange transition-colors"
        >
      ...
      {calculatingFor === null && flowStep === "offer1" && (
        <div className="space-y-4">
          ...
          <button type="button" onClick={handleContinueToFiscal} disabled={isSubmitting}
            className="w-full bg-rappi-orange text-white font-bold h-12 rounded-btn text-[16px] transition-colors hover:bg-rappi-orange-dark focus:outline-none focus-visible:ring-2 focus-visible:ring-rappi-orange focus-visible:ring-offset-2 disabled:opacity-40 inline-flex items-center justify-center gap-2">
          ...
          <button type="button" onClick={handleApplyFromOffer1} disabled={isSubmitting}
            className="w-full bg-white border-2 border-rappi-orange text-rappi-orange font-bold h-12 rounded-btn text-[16px] transition-colors hover:bg-rappi-orange-light focus:outline-none focus-visible:ring-2 focus-visible:ring-rappi-orange focus-visible:ring-offset-2 disabled:opacity-40">
      ...
      {calculatingFor === null && flowStep === "offer2" && (
        <div className="space-y-4">
          ...
          <button type="button" onClick={handleApplyFinal} disabled={isSubmitting}
            className="w-full bg-rappi-orange text-white font-bold h-12 rounded-btn text-[16px] transition-colors hover:bg-rappi-orange-dark focus:outline-none focus-visible:ring-2 focus-visible:ring-rappi-orange focus-visible:ring-offset-2 disabled:opacity-40">
