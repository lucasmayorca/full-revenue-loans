...
export function StepConsentSocial({
  ...
  const urlInputClass =
    "w-full h-10 px-3 border border-uber-gray-300 rounded-btn text-[14px] focus:outline-none focus:border-rappi-orange transition-colors placeholder:text-uber-gray-500 bg-white";
            ...
            <div className="flex items-start gap-3 flex-1">
              <div className="w-8 h-8 bg-pink-50 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                <svg viewBox="0 0 24 24" className="w-5 h-5">
                  <defs>
                    <linearGradient id="ig-csc-rappi" x1="0%" y1="100%" x2="100%" y2="0%">
