      ...
      <div className="space-y-1">
        ...
        >
          <input
            ...
            type="checkbox"
            {...props}
            className="mt-1 w-[18px] h-[18px] rounded-[2px] border-uber-gray-500 text-rappi-orange focus:ring-rappi-orange focus:ring-offset-0 cursor-pointer flex-shrink-0 accent-[#FF441F]"
          />
